        ...
        <?php
          ...
          foreach ($picksters_weekly_games as $game) {
           ...
           <li>
               ...
               <input class='picksters_radio_field' type='radio' id='picksters_radio_game<?php echo $counter?>' name='game<?php echo $counter?>' value='<?php echo $game[home_team_name]?>'/>
               <input class='picksters_radio_field' type='radio' id='picksters_radio_game<?php echo $counter?>' name='game<?php echo $counter?>' value='<?php echo $game[away_team_name]?>'/>
           </li>
            <?php
            echo "Game #" . $counter;
            $counter += $counter;
