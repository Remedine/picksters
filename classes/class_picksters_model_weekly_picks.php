...
class Picksters_Model_Weekly_Picks {
	...
	public function process_picks() {
		global $picksters_weekly_picks_params, $picksters;
	...
	/**
	 * Check if user has picked games for stated week. If picked will return an array of the games.
	 *
	 * @since 1.0.0
	 *
	 * @param $user_id
